...
2. Đọc ngưỡng từ `TEMP_THRESHOLD_C` (mặc định 30°C). Dùng `gpiozero.LED` để điều khiển chân GPIO đã chốt ở bước 1.
...
4. Tắt LED và giải phóng GPIO khi chương trình kết thúc.
...
- Khi người dùng kết thúc, LED tắt và GPIO được giải phóng.
